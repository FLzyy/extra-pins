...
#DIV_1 {
    block-size: 107px;
    border-block-end-color: rgb(208, 215, 222);
    border-block-end-style: solid;
    border-block-end-width: 1px;
    border-block-start-color: rgb(208, 215, 222);
    border-block-start-style: solid;
    border-block-start-width: 1px;
    border-end-end-radius: 6px;
    border-end-start-radius: 6px;
    border-inline-end-color: rgb(208, 215, 222);
    border-inline-end-style: solid;
    border-inline-end-width: 1px;
    border-inline-start-color: rgb(208, 215, 222);
    border-inline-start-style: solid;
    border-inline-start-width: 1px;
    border-start-end-radius: 6px;
    border-start-start-radius: 6px;
    box-sizing: border-box;
    caret-color: rgb(36, 41, 47);
    color: rgb(36, 41, 47);
    column-rule-color: rgb(36, 41, 47);
    display: flex;
    height: 107px;
    inline-size: 440px;
    min-block-size: auto;
    ...
    text-align: left;
    text-decoration: none solid rgb(36, 41, 47);
    text-emphasis-color: rgb(36, 41, 47);
...
#DIV_1:after {
    border-block-end-color: rgb(36, 41, 47);
    border-block-start-color: rgb(36, 41, 47);
    border-inline-end-color: rgb(36, 41, 47);
    border-inline-start-color: rgb(36, 41, 47);
    caret-color: rgb(36, 41, 47);
    color: rgb(36, 41, 47);
    column-rule-color: rgb(36, 41, 47);
    display: block;
...
#svg_5 {
    block-size: 16px;
    border-block-end-color: rgb(87, 96, 106);
    border-block-start-color: rgb(87, 96, 106);
    border-inline-end-color: rgb(87, 96, 106);
    border-inline-start-color: rgb(87, 96, 106);
    box-sizing: border-box;
    caret-color: rgb(87, 96, 106);
    color: rgb(87, 96, 106);
    column-rule-color: rgb(87, 96, 106);
    ...
    text-align: left;
    text-decoration: none solid rgb(87, 96, 106);
    text-emphasis-color: rgb(87, 96, 106);
    text-size-adjust: 100%;
    transform-origin: 8px 8px;
    vertical-align: text-bottom;
    width: 16px;
    border: 0px none rgb(87, 96, 106);
    font: 14px / 21px -apple-system, BlinkMacSystemFont, "Segoe UI", "Noto Sans", Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji";
    list-style: outside none none;
...
#A_7 {
    border-block-end-color: rgb(9, 105, 218);
    border-block-start-color: rgb(9, 105, 218);
    border-inline-end-color: rgb(9, 105, 218);
    border-inline-start-color: rgb(9, 105, 218);
    box-sizing: border-box;
    caret-color: rgb(9, 105, 218);
    color: rgb(9, 105, 218);
    column-rule-color: rgb(9, 105, 218);
    margin-inline-end: 4px;
    overflow-wrap: break-word;
    perspective-origin: 0px 0px;
    text-align: left;
    text-decoration: none solid rgb(9, 105, 218);
    text-emphasis-color: rgb(9, 105, 218);
    text-size-adjust: 100%;
    transform-origin: 0px 0px;
    word-break: break-word;
    border: 0px none rgb(9, 105, 218);
    ...
    list-style: outside none none;
    margin: 0px 4px 0px 0px;
    outline: rgb(9, 105, 218) none 0px;
}/*#A_7*/
...
#INPUT_12 {
    ...
    border-start-end-radius: 6px;
    border-start-start-radius: 6px;
    box-shadow: rgba(208, 215, 222, 0.2) 0px 1px 0px 0px inset;
    caret-color: rgb(36, 41, 47);
    color: rgb(36, 41, 47);
    column-rule-color: rgb(36, 41, 47);
    cursor: default;
    ...
    background: rgb(255, 255, 255) none no-repeat scroll right 8px 50% / auto padding-box border-box;
    border: 1px solid rgb(208, 215, 222);
    border-radius: 6px;
...
#BUTTON_16, #BUTTON_19 {
    appearance: button;
    block-size: 1px;
    border-block-end-color: rgba(27, 31, 36, 0.15);
    border-block-end-style: solid;
    border-block-end-width: 1px;
    border-block-start-color: rgba(27, 31, 36, 0.15);
    border-block-start-style: solid;
    border-block-start-width: 1px;
    border-end-end-radius: 6px;
    border-end-start-radius: 6px;
    border-inline-end-color: rgba(27, 31, 36, 0.15);
    border-inline-end-style: solid;
    border-inline-end-width: 1px;
    border-inline-start-color: rgba(27, 31, 36, 0.15);
    border-inline-start-style: solid;
    border-inline-start-width: 1px;
    border-start-end-radius: 6px;
    border-start-start-radius: 6px;
...
#SPAN_25 {
    block-size: 12px;
    border-block-end-color: rgba(27, 31, 36, 0.1);
    border-block-end-style: solid;
    border-block-end-width: 1px;
    border-block-start-color: rgba(27, 31, 36, 0.1);
    border-block-start-style: solid;
    border-block-start-width: 1px;
    border-end-end-radius: 50%;
    border-end-start-radius: 50%;
    border-inline-end-color: rgba(27, 31, 36, 0.1);
    border-inline-end-style: solid;
    border-inline-end-width: 1px;
    border-inline-start-color: rgba(27, 31, 36, 0.1);
    border-inline-start-style: solid;
    border-inline-start-width: 1px;
